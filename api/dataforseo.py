...
class DataForSEOClient:
    ...
    def __init__(self, login: str, password: str, base_url: str = DEFAULT_BASE):
        ...
        self.headers = {
            ...
            "User-Agent": "shopping-api-tester/1.0"
        }
    ...
    def _wait_for_result(self, get_path: str, max_wait_sec: int = 45, poll_every: float = 2.0) -> Dict:
    ...
    def search_products(self, keyword: str, location_code: int = 2826, language_code: str = "en", depth: int = 100) -> Dict:
        payload = [{
            "keyword": keyword,
        ...
        return self._wait_for_result(f"/merchant/google/products/task_get/advanced/{task_id}")

    def get_product_info(self, product_id: str, location_code: int = 2826, language_code: str = "en") -> Dict:
        payload = [{
        ...
        task_id = post["tasks"][0]["id"]
        return self._wait_for_result(f"/merchant/google/product_info/task_get/advanced/{task_id}")
